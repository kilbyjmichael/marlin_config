...
#define STRING_CONFIG_H_AUTHOR "(kilbyjmichael, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "PlasticPooper"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "66666666-6969-6969-6969-999999999999"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -7, -1.58 }
...
//#define LEVEL_BED_CORNERS
   ...
   */
  #define LEVEL_CORNERS_LEVELING_ORDER {LB,LF}
#endif
